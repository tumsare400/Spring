...
public class LoggingAspects{
   ...
   public void logAround(ProceedingJoinPoint jp)throws Throwable
   {
 	...
 	@AfterThrowing
 	 (pointcut="execution(*com.capgemini.spring.calculator.Calculator.substraction(..))", throwing = "ex")
    
        	public void logThrow(JoinPoint joinpoint, Throwable ex) throws Throwable  
